...
class PostStudyResult(object):
    ...
    def __init__(self, study_id=None):  # noqa: E501
        """PostStudyResult - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PostStudyResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PostStudyResult):
            return False
