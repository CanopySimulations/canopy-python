...
class DocumentCustomPropertyData(object):
    ...
    def __init__(self, name=None, value=None):  # noqa: E501
        """DocumentCustomPropertyData - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DocumentCustomPropertyData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DocumentCustomPropertyData):
            return False
