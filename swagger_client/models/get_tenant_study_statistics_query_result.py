...
class GetTenantStudyStatisticsQueryResult(object):
    ...
    def __init__(self, statistics=None):  # noqa: E501
        """GetTenantStudyStatisticsQueryResult - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetTenantStudyStatisticsQueryResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetTenantStudyStatisticsQueryResult):
            return False
