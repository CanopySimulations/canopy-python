...
class UpdatedTenantDefaultCustomPropertyNames(object):
    ...
    def __init__(self, default_custom_property_names=None):  # noqa: E501
        """UpdatedTenantDefaultCustomPropertyNames - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdatedTenantDefaultCustomPropertyNames, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatedTenantDefaultCustomPropertyNames):
            return False
