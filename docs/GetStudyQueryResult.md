...
**converted_sim_version** | **object** | The sim version the study data was converted to. | [optional] 
...
**priority** | **object** | The priority if the study is running. Otherwise null. | [optional] 
