...
class GetConfigVersionsQueryResult(object):
    ...
    def __init__(self, versions=None, user_information=None, local_vars_configuration=None):  # noqa: E501
        """GetConfigVersionsQueryResult - a model defined in OpenAPI"""  # noqa: E501
