...
class SimVersionPostSimVersionRequest(object):
    ...
    def __init__(self, sim_version=None, local_vars_configuration=None):  # noqa: E501
        """SimVersionPostSimVersionRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimVersionPostSimVersionRequest):
            return False
