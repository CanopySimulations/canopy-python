...
class ConfigPutConfigOwnerRequest(object):
    ...
    def __init__(self, user_id=None, local_vars_configuration=None):  # noqa: E501
        """ConfigPutConfigOwnerRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigPutConfigOwnerRequest):
            return False
