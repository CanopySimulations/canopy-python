...
class ListFilterApi(object):
    ...
    def list_filter_upgrade_list_filter(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.list_filter_upgrade_list_filter_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def list_filter_upgrade_list_filter_with_http_info(self, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method list_filter_upgrade_list_filter" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='ListFilter',  # noqa: E501
