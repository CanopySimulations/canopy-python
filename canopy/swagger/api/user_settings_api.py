...
class UserSettingsApi(object):
    ...
    def user_settings_get_user_settings(self, tenant_id, user_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.user_settings_get_user_settings_with_http_info(tenant_id, user_id, **kwargs)  # noqa: E501
            return data
    ...
    def user_settings_get_user_settings_with_http_info(self, tenant_id, user_id, **kwargs):  # noqa: E501
        ...
        if ('tenant_id' not in params or
            ...
            raise ValueError("Missing the required parameter `tenant_id` when calling `user_settings_get_user_settings`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `user_settings_get_user_settings`")  # noqa: E501
    ...
    def user_settings_put_user_settings(self, tenant_id, user_id, data, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.user_settings_put_user_settings_with_http_info(tenant_id, user_id, data, **kwargs)  # noqa: E501
            return data
    ...
    def user_settings_put_user_settings_with_http_info(self, tenant_id, user_id, data, **kwargs):  # noqa: E501
        ...
        if ('tenant_id' not in params or
                params['tenant_id'] is None):
            raise ValueError("Missing the required parameter `tenant_id` when calling `user_settings_put_user_settings`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `user_settings_put_user_settings`")  # noqa: E501
        # verify the required parameter 'data' is set
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `user_settings_put_user_settings`")  # noqa: E501
