...
class PoolApi(object):
    ...
    def pool_get_pool_status(self, tenant_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.pool_get_pool_status_with_http_info(tenant_id, **kwargs)  # noqa: E501
            return data
    ...
    def pool_get_pool_status_with_http_info(self, tenant_id, **kwargs):  # noqa: E501
        ...
        all_params = ['tenant_id', 'pool_type']  # noqa: E501
        ...
        if ('tenant_id' not in params or
            ...
            raise ValueError("Missing the required parameter `tenant_id` when calling `pool_get_pool_status`")  # noqa: E501
        ...
        if 'pool_type' in params:
            query_params.append(('poolType', params['pool_type']))  # noqa: E501
    ...
    def pool_get_pools(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.pool_get_pools_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def pool_get_test_auto_scale_formula(self, tenant_id, pool_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.pool_get_test_auto_scale_formula_with_http_info(tenant_id, pool_id, **kwargs)  # noqa: E501
            return data
    ...
    def pool_get_test_auto_scale_formula_with_http_info(self, tenant_id, pool_id, **kwargs):  # noqa: E501
        ...
        all_params = ['tenant_id', 'pool_id', 'formula']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('tenant_id' not in params or
                params['tenant_id'] is None):
            raise ValueError("Missing the required parameter `tenant_id` when calling `pool_get_test_auto_scale_formula`")  # noqa: E501
        # verify the required parameter 'pool_id' is set
        if ('pool_id' not in params or
                params['pool_id'] is None):
            raise ValueError("Missing the required parameter `pool_id` when calling `pool_get_test_auto_scale_formula`")  # noqa: E501
        ...
        if 'formula' in params:
            query_params.append(('formula', params['formula']))  # noqa: E501
