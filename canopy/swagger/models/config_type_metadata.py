...
class ConfigTypeMetadata(object):
    ...
    def __init__(self, singular_key=None, plural_key=None, name=None, title_name=None, icon=None):  # noqa: E501
        """ConfigTypeMetadata - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigTypeMetadata, dict):
