...
class NewStudyData(object):
    ...
    def __init__(self, name=None, is_transient=None, study_type=None, sources=None, properties=None, study=None, notes=None, sim_version=None):  # noqa: E501
        """NewStudyData - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NewStudyData, dict):
