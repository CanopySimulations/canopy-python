...
class BatchCreateConfigsResult(object):
    ...
    def __init__(self, config_ids=None):  # noqa: E501
        """BatchCreateConfigsResult - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BatchCreateConfigsResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchCreateConfigsResult):
            return False
